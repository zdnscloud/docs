...
Zcloud是企业级容器云的完整解决方案。Zcloud可以帮助企业在生产环境中轻松快捷的部署和管理容器，并帮助企业可以快捷的适应云原生，应用云原生，最终实现企业IT支撑系统的迅速迭代，提高企业的生产力。Zcloud深度整合 Kubernetes，为用户提供以多集群、多租户为核心的资源管理能力，以应用商店、可视化编排为核心的应用部署能力。Zcloud能够支持企业建立一个覆盖内外部各环节和组织结构的私有云平台。
...
![img](D:/myjobs/myjob_zcloud/docs/zcloud/v2.0/product/architecture_back.jpg)
每个Zcloud组件的功能如下:
**Zcloud**
